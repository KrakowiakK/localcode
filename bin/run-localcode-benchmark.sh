...
LOCALCODE_TASK_OUTPUT_MODE="${LOCALCODE_TASK_OUTPUT_MODE:-runtime}"
LOCALCODE_BENCHMARK_OUTPUT_MODE="${LOCALCODE_BENCHMARK_OUTPUT_MODE:-runtime}"
LOCALCODE_TASK_SKIP_READONLY="${LOCALCODE_TASK_SKIP_READONLY:-}"
LOCALCODE_WRITE_VERBOSE_STATE="${LOCALCODE_WRITE_VERBOSE_STATE:-1}"
LOCALCODE_EDIT_VERBOSE_STATE="${LOCALCODE_EDIT_VERBOSE_STATE:-}"
LOCALCODE_EDIT_SNIPPET_SUCCESS="${LOCALCODE_EDIT_SNIPPET_SUCCESS:-}"
LOCALCODE_WRITE_SNIPPET_SUCCESS="${LOCALCODE_WRITE_SNIPPET_SUCCESS:-}"
LOCALCODE_ENFORCE_READ_BEFORE_WRITE="${LOCALCODE_ENFORCE_READ_BEFORE_WRITE:-1}"
LOCALCODE_INJECT_TESTS_ON_WRITE="${LOCALCODE_INJECT_TESTS_ON_WRITE:-}"
LOCALCODE_WRITE_SPEC_FOCUS="${LOCALCODE_WRITE_SPEC_FOCUS:-1}"
LOCALCODE_WRITE_SPEC_CONTRACT="${LOCALCODE_WRITE_SPEC_CONTRACT:-}"
LOCALCODE_PATH_AUTOCORRECT_GLOBAL="${LOCALCODE_PATH_AUTOCORRECT_GLOBAL:-}"
export LOCALCODE_TURN_SUMMARY
export LOCALCODE_STREAM_OUTPUT
export LOCALCODE_TASK_OUTPUT_MODE
export LOCALCODE_BENCHMARK_OUTPUT_MODE
export LOCALCODE_TASK_SKIP_READONLY
export LOCALCODE_WRITE_VERBOSE_STATE
export LOCALCODE_EDIT_VERBOSE_STATE
export LOCALCODE_EDIT_SNIPPET_SUCCESS
export LOCALCODE_WRITE_SNIPPET_SUCCESS
export LOCALCODE_ENFORCE_READ_BEFORE_WRITE
export LOCALCODE_INJECT_TESTS_ON_WRITE
export LOCALCODE_WRITE_SPEC_FOCUS
export LOCALCODE_WRITE_SPEC_CONTRACT
export LOCALCODE_PATH_AUTOCORRECT_GLOBAL
